    ...
    <div className="flex min-h-dvh flex-col bg-neutral-950">
      ...
      <div className="flex flex-1 items-center justify-center px-4 py-10">
        <div className="w-full max-w-sm">
          ...
          <h1 className="text-2xl font-black text-neutral-100">Create a room</h1>
          <p className="mt-1 text-sm text-neutral-500">
            You&apos;ll be the host. Others join with the code you&apos;ll get next.
          </p>
          ...
          <p className="mt-5 text-center text-sm text-neutral-500">
            Have a code?{' '}
            <Link to="/join-room" className="font-semibold text-amber-400 hover:text-amber-300">
              Join a room
            </Link>
          </p>
        </div>
